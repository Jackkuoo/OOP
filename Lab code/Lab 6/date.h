...

{
	...
	void printMonthDDYYYY() const; // print date in Month dd, yyyyformat
...
private:
	...
	int daysInMonth( int ) const; // returns number of days in givenmonth
    
	bool isLeapYear() const; // indicates whether date is in a leap year
    
	int convertDDToDDD() const; // get 3-digit day based on month andday day
    
	void setMMDDFromDDD( int ); // set month and day based on 3-digit
